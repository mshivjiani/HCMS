<%@ Control Language="C#" AutoEventWireup="false" CodeBehind="ctrlAbolishedPositions.ascx.cs" Inherits="HCMS.OrgChart.Controls.Positions.ctrlAbolishedPositions" %>
...
<custom:OrgChartDetailInformation id="customOrgChartDetails" runat="server" RedirectSuffix="abol" ShowAbolishedPositionsLink="false" />

<br />
<div><hr class="separator" /></div><br /> 
<div class="highlight1">Abolished Positions for Organization Chart</div>
<br />
...
<table>
    <tr>
        <td width="25"><custom:ToolTip ID="toolTipExcludeAbolishedPosition" runat="server" ToolTipID="218" /></td>
        <td>Exclude Column</td>
        <td align="center" width="25">-</td>

        <td width="25"><custom:ToolTip ID="toolTipDeleteAbolishedPosition" runat="server" ToolTipID="219" /></td>
        <td>Delete Column</td>
    </tr>
</table>
<br />
...
<telerik:RadGrid ID="gridPositions" runat="server" AutoGenerateColumns="False" AllowSorting="true" AllowPaging="true" 
        ...
        <MasterTableView DataKeyNames="WFPPositionID">            
            <NoRecordsTemplate>There are no new abolished positions currently associated with this organization chart.</NoRecordsTemplate>
            <Columns>
                <telerik:GridTemplateColumn UniqueName="DeleteColumn" HeaderText="Delete" ItemStyle-HorizontalAlign="Center" Headerstyle-Width="25px" Itemstyle-Width="25px">
                <ItemTemplate>
                    <asp:Literal id="literalNoDelete" runat="server" text="N/A" />
                    <asp:ImageButton ID="imageButtonDelete" runat="server" CommandName="Delete" SkinID="deleteButton" AlternateText="Permanently Delete this Position from the System" ToolTip="Permanently Delete this Position from the System" />
                </ItemTemplate>
