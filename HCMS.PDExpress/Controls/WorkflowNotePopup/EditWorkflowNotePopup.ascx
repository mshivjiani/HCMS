<%@ Control Language="C#" AutoEventWireup="false" CodeBehind="EditWorkflowNotePopup.ascx.cs" Inherits="HCMS.PDExpress.Controls.WorkflowNotePopup.EditWorkflowNotePopup1" %>
...
<telerik:RadCodeBlock ID="rcbCodeBlock" runat="server">
    <script type="text/javascript">
        ...
        function EditWorkflowNotePopupCtrlClose()
        {
            GetRadWindow().close();
        }
    </script>
...
<div style="border-bottom:solid 1px #9cb6c5;"> 
    ...
    <col width="210px" />
        ...
        <tr>
            <td>Status</td>
            <td colspan="3"><telerik:RadComboBox ID="ddlStatus" runat="server" DataTextField="NoteStatusName" DataValueField="NoteStatusID" /></td>
        </tr>
        <tr>
            <td>&nbsp;</td>
            <td colspan="3" align="right">
                <asp:Button ID="btnSaveEditWorkflowNote" runat="server" Text="&nbsp;Save and Close&nbsp;" ToolTip="Save and Close" OnClientClick="EditWorkflowNotePopupCtrlClose();" OnClick="btnSaveEditWorkflowNote_Click" />
                <asp:Button ID="btnCloseEditWorkflowNote" runat="server" Text="&nbsp;Close&nbsp;" ToolTip="Close" OnClientClick="EditWorkflowNotePopupCtrlClose(); return false;" />
            </td>
        </tr>
    </table>
</div>