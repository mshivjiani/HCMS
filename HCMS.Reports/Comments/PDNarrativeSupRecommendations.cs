namespace HCMS.Reports.Comments
{
    ...
    /// <summary>
    /// Summary description for PDNarrativeSupRecommendations.
    /// </summary>
    public partial class PDNarrativeSupRecommendations : Telerik.Reporting.Report
    {
        public PDNarrativeSupRecommendations()
        {
            /// <summary>
        ...
        private void PDNarrativeSupRecommendations_NeedDataSource(object sender, EventArgs e)
        {
            try
            {
