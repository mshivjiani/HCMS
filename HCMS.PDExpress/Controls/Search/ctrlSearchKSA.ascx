<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ctrlSearchKSA.ascx.cs"
    Inherits="HCMS.PDExpress.Controls.Search.ctrlSearchKSA" %>
<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="asp" %>
<%@ Register Assembly="Telerik.Web.UI" Namespace="Telerik.Web.UI" TagPrefix="telerik" %>

<asp:Panel ID="pnlSearch" runat="server" CssClass="controlContentPanel" DefaultButton="btnSearch">
    <span class="controlPartsWrapper"><span class="controlLeftPart">
    ...
    </span>&nbsp; <span id="spanright" runat="server" visible="false">
