...
using Enterprise = Microsoft.Practices.EnterpriseLibrary.Data;
using EnterpriseSQL = Microsoft.Practices.EnterpriseLibrary.Data.Sql;
...
namespace HCMS.Business.Common
{
    ...
    public class TransactionManager
    {
        ...
        private Enterprise.Database _database;
        ...
        public TransactionManager(string connectionString)
        {
            ...
            this._database = new EnterpriseSQL.SqlDatabase(connectionString);
            this.connection = this._database.CreateConnection();
        }

        public TransactionManager(Microsoft.Practices.EnterpriseLibrary.Data.Database currentDatabase)
        {
            this._database = currentDatabase;
            this.connection = this._database.CreateConnection();
        }
        ...
        /// </summary>
        /// <value></value>
        public Enterprise.Database Database
        {
            get
            {
