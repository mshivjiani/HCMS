<%@ Control Language="C#" AutoEventWireup="false" CodeBehind="ctrlFPPSPositionInformation.ascx.cs" Inherits="HCMS.OrgChart.Controls.Positions.Common.ctrlFPPSPositionInformation" %>

<table class="blueTable" width="100%">
    <tr>
        <td align="right">
            <asp:Label ID="labelOrgCode" runat="server" ToolTip="Org Code:" Text="Org Code:" AssociatedControlID="literalOrgCode" />
            &nbsp;<custom:tooltip ID="tooltipOrgCode" runat="server" ToolTipID="0" />
        </td>
    ...
    <tr>
        <td width="200" align="right">
            ...
            &nbsp;<custom:tooltip ID="tooltipPositionTitle" runat="server" ToolTipID="0" />
        </td>
     ...
     <tr>
        <td align="right"><asp:Label ID="labelPositionStatus" runat="server" ToolTip="Position Status:" Text="Position Status:" AssociatedControlID="literalPositionStatus"></asp:Label>
            &nbsp;<custom:tooltip ID="tooltipPositionStatus" runat="server" ToolTipID="0" /></td>
    ...
    <tr id="rowFullName" runat="server">
        <td align="right"><asp:Label ID="labelFullName" runat="server" ToolTip="Name:" Text="Name:" AssociatedControlID="literalFullName"></asp:Label>
            &nbsp;<custom:tooltip ID="tooltipFullName" runat="server" ToolTipID="0" /></td>
        <td colspan="3"><asp:Literal ID="literalFullName" runat="server" /></td>
    </tr>
   

    <tr id="rowEmploymentStatus" runat="server">
        <td align="right"><asp:Label ID="labelEmploymentStatus" runat="server" ToolTip="Employment Status:" Text="Name:" AssociatedControlID="literalEmploymentStatus"></asp:Label>
            &nbsp;<custom:tooltip ID="tooltipEmploymentStatus" runat="server" ToolTipID="0" /></td>
    ...
    <tr>
        <td align="right"><asp:Label ID="labelPayPlan" runat="server" ToolTip="Pay Plan:" Text="Pay Plan:" AssociatedControlID="literalPayPlan"></asp:Label>
            &nbsp;<custom:tooltip ID="tooltipPayPlan" runat="server" ToolTipID="0" /></td>
        ...
        <td align="right"><asp:Label ID="labelSeries" runat="server" ToolTip="Series:" Text="Series:" AssociatedControlID="literalSeries"></asp:Label>
            &nbsp;<custom:tooltip ID="tooltipSeries" runat="server" ToolTipID="0" /></td>
    ...
    <tr>
        <td align="right">
            ...
            &nbsp;<custom:tooltip ID="tooltipFPLGrade" runat="server" ToolTipID="0" />
        </td>
        ...
        <td width="200" align="right">
            ...
            &nbsp;<custom:tooltip ID="tooltipCurrentGrade" runat="server" ToolTipID="0" />
        </td>
    ...
    <tr>
        <td align="right">
            ...
            &nbsp;<custom:tooltip ID="tooltipDutyStationCountry" runat="server" ToolTipID="0" />
        </td>
    ...
    <tr id="rowDutyStationState" runat="server" visible="false">
        <td align="right">
            ...
            &nbsp;<custom:tooltip ID="tooltipDutyStationState" runat="server" ToolTipID="0" />
        </td>
    ...
    <tr>
        <td align="right">
            ...
            &nbsp;<custom:tooltip ID="tooltipDutyStationCity" runat="server" ToolTipID="0" />
        </td>
    ...
    <tr>
        <td align="right">
            ...
            &nbsp;<custom:tooltip ID="tooltipPositionTypesSupervisoryStatus" runat="server" ToolTipID="0" />
        </td>
    ...
    <tr>
        <td align="right">
            ...
            &nbsp;<custom:tooltip ID="tooltipOrganizationPositionType" runat="server" ToolTipID="0" />
        </td>
