<%@ Control Language="C#" AutoEventWireup="false" CodeBehind="ctrlAddWFPPosition.ascx.cs" Inherits="HCMS.OrgChart.Controls.Positions.ctrlAddWFPPosition" %>
...
<custom:OrgChartDetailInformation id="customOrgChartDetails" runat="server" RedirectSuffix="posadd" />

<br />
<div><hr class="separator" /></div><br /> 
<div class="highlight1">New WFP Position Information</div>
<br />

<custom:ErrorMessage id="customAddNewErrorMessage" runat="server" />
<asp:ValidationSummary ID="valSummary" runat="server" CssClass="validationMessageBox"
                            ...
                            DisplayMode="BulletList" ValidationGroup="NewPosition" />
...
<table class="blueTable" width="100%">
    <tr id="rowSingleOrgCode" runat="server">
        ...
        <td class="highlight1"><asp:Literal ID="literalSingleOrgCode" runat="server" /></td>
    </tr>
    ...
    <tr id="rowMultipleOrgCodes" runat="server" visible="false">
        ...
        <telerik:RadComboBox ID="dropDownMultipleOrgCodes" runat="server" Width="600px" />
            <asp:RequiredFieldValidator ID="requiredMultipleOrgCodes" runat="server" ControlToValidate="dropDownMultipleOrgCodes" 
                ...
                Display="None" ValidationGroup="NewPosition" />
        </td>
    </tr>
    ...
    <tr>
        ...
        <td>
            ...
            <asp:RequiredFieldValidator ID="requiredPositionTitle" runat="server" ControlToValidate="textboxPositionTitle" 
                ErrorMessage="The 'Position Title' is a required field." Display="None" ValidationGroup="NewPosition" />
        </td>
    </tr>
        ...
        <table class="noBorderInnerTable" width="100%">
            ...
            <td width="140">
                ...
                <asp:RequiredFieldValidator ID="requiredFirstName" runat="server" ControlToValidate="textboxFirstName" 
                    ErrorMessage="The 'First Name' is a required field." Display="None" ValidationGroup="NewPosition" />
            </td>
            <td width="95">
            ...
            <td>
                ...
                <asp:RequiredFieldValidator ID="requiredLastName" runat="server" ControlToValidate="textboxLastName" 
                    ErrorMessage="The 'Last Name' is a required field." Display="None" ValidationGroup="NewPosition" />
            </td>
            </tr>
        </table>
        </asp:Panel>
                ...
                <table class="noBorderInnerTable" cellpadding="0" cellspacing="0" width="100%">
                    <tr>
                        ...
                        <asp:CompareValidator ID="compareFPLAndCurrentGrade" runat="server" ControlToValidate="dropDownFPLGrades" 
                            ...
                            Operator="GreaterThanEqual" Type="Integer"  Display="None" ValidationGroup="NewPosition" />
                        </td>
    ...
    <tr>
        ...
        <td>
            ...
            <asp:RequiredFieldValidator ID="requiredDutyStationCity" runat="server" ControlToValidate="textboxDutyStationCity" 
                ErrorMessage="The 'Duty Station City' is a required field." Display="None" ValidationGroup="NewPosition" />
        </td>
    </tr>
    ...
    <tr>
        <td width="200" align="right">
            ...
            <span class="required">*</span> &nbsp;<custom:tooltip ID="tooltipReportsToPosition" runat="server" ToolTipID="267" />
        </td>
        <td>
            ...
            <asp:RequiredFieldValidator ID="requiredParentPosition" runat="server" ControlToValidate="dropDownParentPositions" InitialValue="<<-- Select Reports To Position -->>" 
                ErrorMessage="The 'Reports to Position' field is a required field." Display="None" ValidationGroup="NewPosition" />
        </td>
    </tr>
    ...
    <tr>
        <td></td>
        <td class="cellAdjustment">
        <asp:Button ID="buttonSave" runat="server" Text="Create New Position" CssClass="button" CausesValidation="true" ValidationGroup="NewPosition" Width="175px" />&nbsp;
