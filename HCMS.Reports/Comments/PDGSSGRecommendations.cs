namespace HCMS.Reports.Comments
{
    ...
    /// <summary>
    /// Summary description for PDGSSGRecommendations.
    /// </summary>
    public partial class PDGSSGRecommendations : Telerik.Reporting.Report
    {
        public PDGSSGRecommendations()
        {
            /// <summary>
        ...
        private void PDGSSGRecommendations_NeedDataSource(object sender, EventArgs e)
        {
            try
            {
