<%@ Page Language="C#" AutoEventWireup="false" CodeBehind="DisplayChart.aspx.cs" Inherits="HCMS.OrgChart.PubOrgChart.DisplayChart" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <custom:DisplayChart id="customDisplayChart" runat="server" PreviewTitle="Published Organization Chart" visible="false" />
    </form>
</body>
</html>
